...
public class CoordinateTest {
  ...
  public void test_row_and_column() {
    ...
    assertEquals(2, coord1.getRow());
    assertEquals(3, coord1.getColumn());
  }
  ...
  public void test_toString() {
    ...
    assertEquals("(0, 3)", c2.toString());
    assertEquals("(25, 9)", c3.toString());
  }
  ...
  void test_string_valid() {
    Coordinate c1 = new Coordinate("Z3");
    assertEquals(25, c1.getRow());
    assertEquals(3, c1.getColumn());

    Coordinate c2 = new Coordinate("a2");
    assertEquals(0, c2.getRow());
